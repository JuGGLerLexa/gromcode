export const createLogger = () => {
  ...
  const warn = str => loggerArr.push({ message: str, dateTime: new Date(), type: 'warn' });

  const error = str => loggerArr.push({ message: str, dateTime: new Date(), type: 'error' });

  const log = str => loggerArr.push({ message: str, dateTime: new Date(), type: 'log' });
